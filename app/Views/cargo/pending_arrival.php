    ...
    <div class="page-header">
        <div class="header-sub-title">
            <nav class="breadcrumb breadcrumb-dash">
                ...
                <span class="breadcrumb-item active"><?= str_replace($page, '_', ' ') ?></span>
            </nav>
        </div>
    </div>
    <div class="container">
                ...
                <div class="row">
                    <div class="col-md-8 offset mx-auto">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label">Expected arrival date</label>
                            <div class="col-md">
                                <input type="date" class="form-control" name="arrival_date" id="cargo_state"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md">
                                <input type="text" name="delivery_town" class="form-control" id="numbers_of_cargo"
