...
<head>
    ...
    <title><?php if (isset($title)) { echo $title; } else { echo "DeliverASAP"; } ?></title>
...
<body>
    <div class="app">
        <div class="layout">
            <!-- Header START -->
            <div class="header">
                <div class="tea-bg logo logo-dark">
                    <!-- //logo here -->
                    <!-- <img src="<?= base_url() ?>/assets/images/logo/logo-white.png" alt="Logo"> -->
                    <h1 class="text-light text-center mt-2"><span>DeliverASAP</span></h1>
                </div>
...
<script> 
    function setEnv() { 
        let a = document.getElementById("bis").value;
